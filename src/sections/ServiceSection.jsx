...
const ServiceSection = () => {
  return (
    <div className="bg-radial-bottom-left flex w-full flex-col items-center justify-center py-12 lg:min-h-screen lg:py-16">
      <div className="container flex flex-col items-center justify-center">
        <div className="flex w-[75%] flex-col items-center justify-center text-center">
          <h2 className="mb-7 text-2xl font-medium text-[#121212] lg:text-5xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-4xl border border-[#6D28D2] py-3 text-center">
              <div className="mb-3 flex items-center justify-center">
                <LiaBookSolid className="rounded-full bg-[#6d28d2] p-4 text-7xl text-white" />
              </div>
            ...
            <div className="rounded-4xl border border-[#6D28D2] py-3 text-center">
              <div className="mb-3 flex items-center justify-center">
                <GoVideo className="rounded-full bg-[#6d28d2] p-4 text-7xl text-white" />
              </div>
            ...
            <div className="rounded-4xl border border-[#6D28D2] py-3 text-center">
              <div className="mb-3 flex items-center justify-center">
                <FaFileAlt className="rounded-full bg-[#6d28d2] p-4 text-7xl text-white" />
              </div>
            ...
            <div className="rounded-4xl border border-[#6D28D2] py-3 text-center">
              <div className="mb-3 flex items-center justify-center">
                <TiMessages className="rounded-full bg-[#6d28d2] p-4 text-7xl text-white" />
              </div>
            ...
            <div className="rounded-4xl border border-[#6D28D2] py-3 text-center">
              <div className="mb-3 flex items-center justify-center">
                <MdOutlineAssessment className="rounded-full bg-[#6d28d2] p-4 text-7xl text-white" />
              </div>
            ...
            <div className="rounded-4xl border border-[#6D28D2] py-3 text-center">
              <div className="mb-3 flex items-center justify-center">
                <TbCertificate className="rounded-full bg-[#6d28d2] p-4 text-7xl text-white" />
              </div>
