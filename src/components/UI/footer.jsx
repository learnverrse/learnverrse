    ...
    return (
        <footer className="container bg-[#121212] py-10 lg:px-10 lg:py-20">
            <div className="m-auto flex w-[90%] flex-col items-start justify-between lg:flex-row">
                ...
                <div className="flex flex-col space-y-6 text-white order-5 md:order-none mb-6 md:mb-0">
                    <img src={logo2} alt="logo" className="hidden md:block"/>
                    <a href="#">About us</a>
                    <a href="#">Careers</a>
                    <a href="#">Blog</a>
                </div>
            ...
            <div className="m-auto mt-16 w-full md:w-[90%]">
                <img src={footerLine} alt="" />
            </div>

            <div className="m-auto mt-10 flex flex-col space-y-5 md:space-y-0 md:flex-row w-[90%] items-center justify-between text-white">
