...
const CongratScreen = ({ userAnswers, quizQuestions, onContinue, onReview, onClose }) => {
  const getScore = () => {
    let userScore = 0;
  ...
  return (
    <div className="h-[calc(100vh-80px)] bg-gray-50 px-5 py-8">
      <div className="relative mx-auto flex w-11/12 flex-col rounded-md bg-white pb-28 shadow-lg">
        <h1 className="mt-24 mb-2 text-center text-2xl font-bold">Congratulations</h1>
        ...
        <div className="mx-auto my-10 grid w-11/12 grid-cols-1 gap-4 rounded-lg border p-6 md:grid-cols-3">
          <div className="flex flex-col items-center">
            ...
            <span className="text-lg font-bold">{score}/{quizQuestions.length}</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-2">
              <img src={vectorImg} alt="" className="h-4 w-4" />
            ...
            <span className="text-lg font-bold">7 minutes</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-2">
              <img src={vectorImg} alt="" className="h-4 w-4" />
